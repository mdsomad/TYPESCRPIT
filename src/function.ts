...
//    return n + m;
// // return String(n + m);
// // Error this --> Type 'string' is not assignable to type 'number'.
// };

// fun(1, 2);  //* 👈 Call this 👆 function

// * 👇 Function Custom DataType created

type CustomDataType = (n: string, m: string) => string;

const fun: CustomDataType = (n, m) => {
  console.log(n, m);
  return n + m;
};
